  ...
  <v-container class="declare-documents">
    <v-row>
      <v-col cols="12">
        ...
        <v-file-upload v-else v-model="coverFile" :disabled="disabled" density="comfortable" title="封面" height="300px"
          accept=".png,.jpg" @update:model-value="handleCoverFileUpdate"></v-file-upload>
      </v-col>
      <v-col cols="12" sm="12">
        <v-text-field v-model="editedItem.name" label="申报名称" :disabled="disabled"></v-text-field>
      </v-col>
      <v-col cols="12" sm="6">
        <v-text-field v-model="editedItem.author" label="作者" :disabled="disabled"></v-text-field>
      </v-col>
      <v-col cols="12" sm="6">
      ...
      <v-col cols="12">
        <DeclareTeam v-model="editedItemDetails.team" :disabled="disabled"></DeclareTeam>
      </v-col>
      <v-col cols="12">
      ...
      <v-col cols="12">
        ...
        <ckeditor v-model="editedItemDetails.target" :editor="editor" :config="editorConfig" :disabled="disabled" />
      </v-col>
      <v-col cols="12">
        <v-responsive class="text-center mx-auto my-10" max-width="700">
        ...
        <ckeditor v-model="editedItemDetails.principle" :editor="editor" :config="editorConfig" :disabled="disabled" />
      </v-col>
      <v-col cols="12">
        <v-responsive class="text-center mx-auto my-10" max-width="700">
        ...
        <ckeditor v-model="editedItemDetails.steps" :editor="editor" :config="editorConfig" :disabled="disabled" />
      </v-col>
    </v-row>
  </v-container>
</template>
